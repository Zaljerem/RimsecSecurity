...
{
    public static class Patch_TryAppendRelationsWithColonistsInfoTwo
    {
        public static void ApplyPatch(Harmony harmony)
        {
            ...
            MethodInfo targetMethod = typeof(PawnRelationUtility).GetMethod(
                ...
                null,
                new[] { typeof(TaggedString).MakeByRefType(), typeof(TaggedString).MakeByRefType(), typeof(Pawn) },
                null
            );
        ...
        public static bool Prefix(ref TaggedString text, ref TaggedString title, Pawn pawn, ref bool __result)
        {
